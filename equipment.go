...
type Equipment struct {
	...
	TunVolume              *float64 `xml:"TUN_VOLUME" json:"tun_volume,omitempty"`
	...
	TopUpWater             *float64 `xml:"TOP_UP_WATER" json:"top_up_water,omitempty"`
	...
	TrubChillerLoss        *float64 `xml:"TRUB_CHILLER_LOSS" json:"trub_chiller_loss,omitempty"`
	// The percentage of wort lost to evaporation per hour of the boil.
	EvapRate               *float64 `xml:"EVAP_RATE" json:"evap_rate,omitempty"`
	...
	LauterDeadspace        *float64 `xml:"LAUTER_DEADSPACE" json:"lauter_deadspace,omitempty"`
	// Amount normally added to the boil kettle before the boil.
	TopUpKettle            *float64 `xml:"TOP_UP_KETTLE" json:"top_up_kettle,omitempty"`
	...
	HopUtilization         *float64 `xml:"HOP_UTILIZATION" json:"hop_utilization,omitempty"`
